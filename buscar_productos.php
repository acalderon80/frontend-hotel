...
<body>
  ...
  <div class=" tabla">
      ...
      if (empty($busqueda)) {
       header("location:buscar_productos.php");
             ...
             <div class="container">
              <table  class="table" >
               ...
               include 'conexion.php';
    	         //paginador
    	         $sql_register = mysqli_query($conection,"SELECT  COUNT(*) as total_registro FROM productos WHERE (id_producto LIKE '%$busqueda%' OR id_categoria LIKE '%$busqueda%' OR nom_producto LIKE '%$busqueda%' OR  desc_producto LIKE '%$busqueda%' OR fec_cambio LIKE '%$busqueda%' OR id_usuario_cambio LIKE '%$busqueda%' OR precio_producto LIKE '%$busqueda%'OR unidades_existentes LIKE '%$busqueda%')");
    	         ...
    	         $query =  mysqli_query($conection,"SELECT  id_producto , id_categoria, nom_producto, desc_producto, fec_cambio, id_usuario_cambio, precio_producto, unidades_existentes FROM productos WHERE(  id_producto LIKE '%$busqueda%' OR id_categoria LIKE '%$busqueda%' OR nom_producto LIKE '%$busqueda%' OR  desc_producto LIKE '%$busqueda%' OR fec_cambio LIKE '%$busqueda%' OR id_usuario_cambio LIKE '%$busqueda%' OR precio_producto LIKE '%$busqueda%'OR unidades_existentes LIKE '%$busqueda%') ORDER BY  id_producto ASC LIMIT $desde, $por_pagina");
