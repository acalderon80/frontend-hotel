        ...
        <input type="submit" value="Buscar" class="btn_search">
         ...
         <div class="container">
              <table  class="table" >
               ...
               $query =  mysqli_query($conection,"SELECT  id_usuario, id_persona,  login, verificado, estatus, fec_cambio  FROM usuarios ORDER BY   id_usuario ASC LIMIT $desde, $por_pagina");
                ...
                while ($data = mysqli_fetch_array($query)) {
                  ?>
                   ...
                   <td data-label ="OPCION" style="padding-top: 8px;">
                    <a href="form_usuarios.php?VALOR=1&ID=<?php echo $data ["id_usuario"] ?>" id="editar" style="text-decoration: none;color: #fff; padding: 5px; background:#DE315D ; border-radius: 5px;height: 15px;">Actualizar</a>

                    <a href="Eliminar.php?TABLA=4&ID=<?php echo $data ["id_usuario"] ?>" id="editar" style="text-decoration: none;color: #fff; padding: 5px; background:#DE315D ; border-radius: 5px;height: 15px;">Eliminar</a></td>
