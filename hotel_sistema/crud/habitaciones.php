        ...
        <h1 id="titulo" style="text-align:center;">Lista de habitaciones</h1>
         <div class="container">
              <table  class="table" >
               ...
               $query =  mysqli_query($conection,"SELECT  id_habitacion, id_tipo_habitacion,  num_habitacion, fec_cambio, id_usuario_cambio,  limpieza,   estado, mantenimiento  FROM habitaciones ORDER BY   id_habitacion ASC LIMIT $desde, $por_pagina");
                ...
                while ($data = mysqli_fetch_array($query)) {
                  ?>
                    ...
                    <td data-label = "pri_nombre"><?php echo $data ["id_tipo_habitacion"] ?></td>
                    ...
                    <td data-label = "razon_social"><?php echo $data ["estado"] ?></td>
                    <td data-label = "razon_social"><?php echo $data ["mantenimiento"] ?></td>
                   <td data-label ="OPCION" style="padding-top: 8px;">

                    <a href="form_personas.php?id_persona=<?php echo $data ["id_habitacion"] ?>" id="editar" style="text-decoration: none;color: #fff; padding: 5px; background:#585CDE; border-radius: 5px;height: 15px;">Editar</a>

                    <a href="Eliminar.php?TABLA=5&ID=<?php echo $data ["id_habitacion"] ?>" id="editar" style="text-decoration: none;color: #fff; padding: 5px; background:#585CDE; border-radius: 5px;height: 15px;">Eliminar</a></td>
