                ...
                while ($data = mysqli_fetch_array($query)) {
                  ?>
                   ...
                   <td data-label ="OPCION" style="padding-top: 8px;">
                    <a href="form_productos.php?VALOR=1&ID=<?php echo $data ["id_producto"] ?>" id="editar" style="text-decoration: none;color: #fff; padding: 5px; background:#585CDE; border-radius: 5px;height: 15px;">Editar</a>

                    <a href="Eliminar.php?TABLA=2&ID=<?php echo $data ["id_producto"] ?>" id="editar" style="text-decoration: none;color: #fff; padding: 5px; background:#585CDE; border-radius: 5px;height: 15px;">Eliminar</a></td>
