        ...
        <h1 id="titulo" style="text-align:center;">Lista de reservaciones</h1>
         <div class="container">
              <table  class="table" >
               ...
               $query =  mysqli_query($conection,"SELECT id_reservacion, fec_cambio,  id_habitacion , id_usuario_cambio,  fec_inicio, fec_fin FROM reservaciones ORDER BY   id_reservacion ASC LIMIT $desde, $por_pagina");
                ...
                while ($data = mysqli_fetch_array($query)) {
                  ?>
                    ...
                    <td data-label = "pri_apellido"><?php echo $data ["id_usuario_cambio"] ?></td>
                   ...
                   <td data-label ="OPCION" style="padding-top: 8px;">
                    <a href="form_reservaciones.php?VALOR=1&ID=<?php echo $data ["id_reservacion"] ?>" id="editar" style="text-decoration: none;color: #fff; padding: 5px; background:#585CDE; border-radius: 5px;height: 15px;">Editar</a>

                    <a href="Eliminar.php?TABLA=3&ID=<?php echo $data ["id_reservacion"] ?>" id="editar" style="text-decoration: none;color: #fff; padding: 5px; background:#585CDE; border-radius: 5px;height: 15px;">Eliminar</a></td>
