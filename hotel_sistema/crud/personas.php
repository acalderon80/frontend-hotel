               ...
               $query =  mysqli_query($conection,"SELECT id_persona, pri_nombre, seg_nombre, pri_apellido, seg_apellido, razon_social, direccion, telefono, correo, identificacion, genero, fec_cambio,id_usuario_cambio FROM personas ORDER BY id_persona ASC LIMIT $desde, $por_pagina");
                ...
                while ($data = mysqli_fetch_array($query)) {
                  ?>
                    ...
                    <td data-label = "genero"><?php echo $data ["genero"] ?></td>
                   ...
                   <td data-label ="OPCION" style="padding-top: 8px;">
                    <a href="form_personas.php?VALOR=1&ID=<?php echo $data ["id_persona"] ?>" id="editar" style="text-decoration: none;color: #fff; padding: 5px; background:#585CDE; border-radius: 5px;height: 15px;">Editar</a>

                    <a href="Eliminar.php?TABLA=1&ID=<?php echo $data ["id_persona"] ?>" id="editar" style="text-decoration: none;color: #fff; padding: 5px; background:#585CDE; border-radius: 5px;height: 15px;">Eliminar</a></td>
