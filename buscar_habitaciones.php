...
<body>
  ...
  <div class=" tabla">
      ...
      if (empty($busqueda)) {
       header("location:buscar_habitaciones.php");
             ...
             <div class="container">
              <table  class="table" >
               ...
               include 'conexion.php';
    	         //paginador
    	         $sql_register = mysqli_query($conection,"SELECT  COUNT(*) as total_registro FROM habitaciones WHERE ( id_habitacion LIKE '%$busqueda%' OR id_persona LIKE '%$busqueda%' OR id_tipo_habitacion LIKE '%$busqueda%' OR  num_habitacion LIKE '%$busqueda%' OR costo_dia LIKE '%$busqueda%' OR limpieza LIKE '%$busqueda%' OR estado LIKE '%$busqueda%' OR mantenimiento LIKE '%$busqueda%' OR fec_cambio LIKE '%$busqueda%')");
    	         ...
    	         $query =  mysqli_query($conection,"SELECT id_habitacion, id_persona, id_tipo_habitacion,  num_habitacion, costo_dia, limpieza, estado, mantenimiento, fec_cambio   FROM habitaciones WHERE(id_habitacion LIKE '%$busqueda%' OR id_persona LIKE '%$busqueda%' OR id_tipo_habitacion LIKE '%$busqueda%' OR  num_habitacion LIKE '%$busqueda%' OR costo_dia LIKE '%$busqueda%' OR limpieza LIKE '%$busqueda%' OR estado LIKE '%$busqueda%' OR mantenimiento LIKE '%$busqueda%' OR fec_cambio LIKE '%$busqueda%') ORDER BY id_habitacion ASC LIMIT $desde, $por_pagina");
