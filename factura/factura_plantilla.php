...
<div id="page_pdf">
	<table id="factura_head">
		<tr>
			...
			<td class="info_empresa">
				<div>
					<span class="h2">SISTEMA DE GESTION HOTELERA ITFIP</span>
					<p>ESPINAL-TOLIMA</p>
					<p>Teléfono: +57 12345678</p>
					<p>Email: Hitfip@gmail.com</p>
				</div>
			</td>
	...
	<div>
		...
		<h4 class="label_gracias">¡Gracias por su estancia!</h4>
	</div>
